...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_5          # Job name
#SBATCH -o fdm_5.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_5.err      # Name of stderr output file(%j expands to jobId)
