...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_17          # Job name
#SBATCH -o fdm_17.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_17.err      # Name of stderr output file(%j expands to jobId)
#SBATCH -N 3                # Total # of nodes
#SBATCH --cpus-per-task 1   # Cores per task requested
#SBATCH -n 17                # Total # of mpi tasks
