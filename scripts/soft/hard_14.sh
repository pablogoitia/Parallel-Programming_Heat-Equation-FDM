...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_14          # Job name
#SBATCH -o fdm_14.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_14.err      # Name of stderr output file(%j expands to jobId)
