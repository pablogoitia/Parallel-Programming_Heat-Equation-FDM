...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_4          # Job name
#SBATCH -o fdm_4.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_4.err      # Name of stderr output file(%j expands to jobId)
