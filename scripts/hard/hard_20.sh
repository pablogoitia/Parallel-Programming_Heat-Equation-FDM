...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_20          # Job name
#SBATCH -o fdm_20.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_20.err      # Name of stderr output file(%j expands to jobId)
