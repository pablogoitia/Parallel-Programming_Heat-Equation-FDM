...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_21          # Job name
#SBATCH -o fdm_21.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_21.err      # Name of stderr output file(%j expands to jobId)
