...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_18          # Job name
#SBATCH -o fdm_18.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_18.err      # Name of stderr output file(%j expands to jobId)
