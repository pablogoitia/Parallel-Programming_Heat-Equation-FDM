...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_24          # Job name
#SBATCH -o fdm_24.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_24.err      # Name of stderr output file(%j expands to jobId)
