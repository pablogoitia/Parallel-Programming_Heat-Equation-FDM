...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_15          # Job name
#SBATCH -o fdm_15.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_15.err      # Name of stderr output file(%j expands to jobId)
