...
# FDM MPI job script
#----------------------------------------------------
#SBATCH -J fdm_23          # Job name
#SBATCH -o fdm_23.out      # Name of stdout output file(%j expands to jobId)
#SBATCH -e fdm_23.err      # Name of stderr output file(%j expands to jobId)
#SBATCH -N 4                # Total # of nodes
#SBATCH --cpus-per-task 1   # Cores per task requested
#SBATCH -n 23                # Total # of mpi tasks
